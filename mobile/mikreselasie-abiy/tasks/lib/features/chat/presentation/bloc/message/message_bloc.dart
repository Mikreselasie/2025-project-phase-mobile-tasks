...
class MessageBloc extends Bloc<MessageEvent, MessageState> {
  ...
  MessageBloc({required this.getChatMessages, required this.sendMessage})
    : super(const MessageInitial([])) {
    on<MessageSocketConnectionRequested>(
      _onLoadMessageRequested,
  ...
  Future<void> _onSendMessageRequested(
    ...
    emit(
      result.fold(
        (l) => MessageSentFailure(state.messages),
