...
import 'package:ecommerce/features/chat/presentation/bloc/message/message_event.dart';
import 'package:ecommerce/features/chat/presentation/bloc/message/message_state.dart';
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        context.read<MessageBloc>().add(
                          MessageSent(chat, _messageController.text, 'text'),
                        );
                      },
