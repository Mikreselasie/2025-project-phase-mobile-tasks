...
import 'package:domain_layer_refactor/features/product/domain/usecases/delete_product.dart';
...
void main() {
  ...
  test('should delete product from the repository', () async {
    ...
    when(
      mockProductRepository.deleteProduct(tProductId),
    ).thenAnswer((_) async => const Right(unit));

    // act
    final result = await deleteProduct(
      DeleteProductParams(productId: tProductId),
    );
